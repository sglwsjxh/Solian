...
_SnPost _$SnPostFromJson(Map<String, dynamic> json) => _SnPost(
  ...
  threadedRepliesCount: (json['threaded_replies_count'] as num?)?.toInt() ?? 0,
  debugRank: (json['debug_rank'] as num?)?.toDouble(),
...
Map<String, dynamic> _$SnPostToJson(_SnPost instance) => <String, dynamic>{
  ...
  'threaded_replies_count': instance.threadedRepliesCount,
  'debug_rank': instance.debugRank,
