// TODO wait till the @CNlongY fix this
// VM is not found
// pkpy.VM? _vm;
...
//       Logger.root.info(
//         '[python_service] Created plugins directory: ${pluginsDir.path}',
//       );
//     }
...
//     final initScripts = allAssets
//         .where(
//           (asset) =>
//               asset.startsWith('assets/scripts/') && asset.endsWith('.py'),
//         )
//         .toList();
//     initScripts.sort();
...
//       _vm!.exec(content);
//       Logger.root.info(
//         '[python_service] Executed plugin: ${path.basename(file.path)}',
//       );
//     }
...
//     _isInitialized = true;
//     Logger.root.info(
//       '[python_service] Initialized with ${initScripts.length} init scripts and ${pluginFiles.length} plugins',
//     );
//   } catch (e) {
