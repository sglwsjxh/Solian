...
class EventCountdownSheet extends HookConsumerWidget {
  final String? username;
  const EventCountdownSheet({super.key, this.username});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SheetScaffold(
      titleText: 'eventCountdowns'.tr(),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          // Filter selector - styled like leaderboard
          Material(
...
class _TimeProgressCard extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Update every second for live progress
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Gap(12),
          // Block-based progress with labels for week
...
class _CountdownCard extends StatelessWidget {
  ...
  double _calculateYearProgress() {
    ...
    // Progress from year start to event date
