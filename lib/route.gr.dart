...
import 'package:island/accounts/screens/check_in.dart' as _i25;
import 'package:island/accounts/screens/event_calendar_screen.dart' as _i47;
import 'package:island/accounts/screens/event_countdown_screen.dart' as _i48;
import 'package:island/accounts/screens/event_hub_screen.dart' as _i49;
...
import 'package:island/auth/create_account.dart' as _i26;
...
import 'package:island/creators/screens/hub.dart' as _i28;
...
import 'package:island/creators/screens/webfeed/webfeed_list.dart' as _i27;
...
import 'package:island/polls/polls_widgets/poll/poll_submit_page.dart' as _i69;
...
class AffiliationDetailRoute
    extends _i92.PageRouteInfo<AffiliationDetailRouteArgs> {
...
class AffiliationRoute extends _i92.PageRouteInfo<void> {
  const AffiliationRoute({List<_i92.PageRouteInfo>? children})
...
class CallRoute extends _i92.PageRouteInfo<CallRouteArgs> {
  ...
  static _i92.PageInfo page = _i92.PageInfo(
    ...
    builder: (data) {
      ...
      return _i18.CallScreen(key: args.key, room: args.room);
    },
  );
}
...
class ChatRoomRoute extends _i92.PageRouteInfo<ChatRoomRouteArgs> {
  ...
  static _i92.PageInfo page = _i92.PageInfo(
    ...
    builder: (data) {
      ...
      return _i23.ChatRoomScreen(key: args.key, id: args.id);
    },
  );
}
...
class CheckInRoute extends _i92.PageRouteInfo<void> {
  ...
  static _i92.PageInfo page = _i92.PageInfo(
    name,
    builder: (data) {
      return const _i25.CheckInScreen();
    },
  );
}

/// generated route for
/// [_i26.CreateAccountScreen]
class CreateAccountRoute extends _i92.PageRouteInfo<void> {
  ...
  static _i92.PageInfo page = _i92.PageInfo(
    name,
    builder: (data) {
      return const _i26.CreateAccountScreen();
    },
  );
}

/// generated route for
/// [_i27.CreatorFeedListScreen]
class CreatorFeedListRoute
  ...
  static _i92.PageInfo page = _i92.PageInfo(
    ...
    builder: (data) {
      ...
      return _i27.CreatorFeedListScreen(key: args.key, pubName: args.pubName);
    },
  );
}
...
class CreatorHubListRoute extends _i92.PageRouteInfo<void> {
  ...
  static _i92.PageInfo page = _i92.PageInfo(
    name,
    builder: (data) {
      return const _i28.CreatorHubListScreen();
    },
  );
}

/// generated route for
/// [_i28.CreatorHubScreen]
class CreatorHubRoute extends _i92.PageRouteInfo<void> {
  ...
  static _i92.PageInfo page = _i92.PageInfo(
    name,
    builder: (data) {
      return const _i28.CreatorHubScreen();
    },
  );
}
...
/// generated route for
/// [_i47.EventCalendarScreen]
class EventCalendarRoute extends _i92.PageRouteInfo<EventCalendarRouteArgs> {
  EventCalendarRoute({
    _i94.Key? key,
    required String name,
    List<_i92.PageRouteInfo>? children,
  }) : super(
         EventCalendarRoute.name,
         args: EventCalendarRouteArgs(key: key, name: name),
         rawPathParams: {'name': name},
         initialChildren: children,
       );

  static const String name = 'EventCalendarRoute';

  static _i92.PageInfo page = _i92.PageInfo(
    name,
    builder: (data) {
      final pathParams = data.inheritedPathParams;
      final args = data.argsAs<EventCalendarRouteArgs>(
        orElse: () =>
            EventCalendarRouteArgs(name: pathParams.getString('name')),
      );
      return _i47.EventCalendarScreen(key: args.key, name: args.name);
    },
  );
}

class EventCalendarRouteArgs {
  const EventCalendarRouteArgs({this.key, required this.name});
  ...
  @override
  String toString() {
    return 'EventCalendarRouteArgs{key: $key, name: $name}';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! EventCalendarRouteArgs) return false;
    return key == other.key && name == other.name;
  }
...
/// generated route for
/// [_i48.EventCountdownScreen]
class EventCountdownRoute extends _i92.PageRouteInfo<EventCountdownRouteArgs> {
  EventCountdownRoute({
    _i94.Key? key,
    required String name,
    List<_i92.PageRouteInfo>? children,
  }) : super(
         EventCountdownRoute.name,
         args: EventCountdownRouteArgs(key: key, name: name),
         rawPathParams: {'name': name},
         initialChildren: children,
       );

  static const String name = 'EventCountdownRoute';

  static _i92.PageInfo page = _i92.PageInfo(
    name,
    builder: (data) {
      final pathParams = data.inheritedPathParams;
      final args = data.argsAs<EventCountdownRouteArgs>(
        orElse: () =>
            EventCountdownRouteArgs(name: pathParams.getString('name')),
      );
      return _i48.EventCountdownScreen(key: args.key, name: args.name);
    },
  );
}

class EventCountdownRouteArgs {
  const EventCountdownRouteArgs({this.key, required this.name});
  ...
  @override
  String toString() {
    return 'EventCountdownRouteArgs{key: $key, name: $name}';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! EventCountdownRouteArgs) return false;
    return key == other.key && name == other.name;
  }
...
/// generated route for
/// [_i49.EventHubScreen]
class EventHubRoute extends _i92.PageRouteInfo<EventHubRouteArgs> {
  EventHubRoute({
    _i94.Key? key,
    required String name,
    List<_i92.PageRouteInfo>? children,
  ...
  static _i92.PageInfo page = _i92.PageInfo(
    ...
    builder: (data) {
      ...
      return _i49.EventHubScreen(key: args.key, name: args.name);
    },
  );
}
...
/// generated route for
/// [_i69.PollSubmitPage]
class PollSubmitRoute extends _i92.PageRouteInfo<PollSubmitRouteArgs> {
  PollSubmitRoute({
    _i94.Key? key,
